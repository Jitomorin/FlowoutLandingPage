...
import FloatingCirclesSpread from 'components/FloatingCirclesSpread';
...
export default function FeaturesGallery() {
  ...
  return (
    <FeaturesGalleryWrapper>
      <Content>
        <SectionTitle>If I let you make me nervous, then we can’t get schwifty.</SectionTitle>
      </Content>
      <GalleryWrapper>
        <CustomButton>Get Swifty</CustomButton>
      </GalleryWrapper>
      <FloatingCirclesSpread />
    </FeaturesGalleryWrapper>
  );
}
